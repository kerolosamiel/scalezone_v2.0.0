...
function FieldDescription({ className, ...props }) {
  return (
    <p
      ...
      className={cn(
        'text-left text-[1.4rem] tracking-[6%] leading-normal font-normal text-muted-foreground group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5',
